...
public class AddEmployee extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String st_address = request.getParameter("diaChi");
            String st_phone = request.getParameter("phone");
            String st_username = request.getParameter("username");
            String st_password = request.getParameter("password");
            String st_role = request.getParameter("role");

            EmployeeDAO dao = new EmployeeDAO();
            dao.insertUser(st_name, st_email, st_address, st_phone, st_username, st_password, st_role);
